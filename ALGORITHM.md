...
|---------|-----------|-------------|---------|
| `strategy_model_stress` | STR-2026-0622-004 | 2 | «Сэйлор декларирует устойчивость — рынок ставит дисконт 0.83x» |
| `etf_institutional_flow` | STR-2026-0619-001 | 2 | «ETF-оттоки как поверхностное давление vs LTH покупают в 10x» |
| `btc_infrastructure_growth` | INF-2026-0609-001 | 2 | «Инфраструктура растёт vs DeFi не находит пользователей» |
| `btc_treasury_competition` | STR-2026-0623-003 | 1 | «Европейские казначейства копируют модель без масштаба» |
| `supply_scarcity` | SUP-2026-0625-001 | 2 | «LTH держат 14.8 млн BTC несмотря на 5.58 млн в убытке» |
