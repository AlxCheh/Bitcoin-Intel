...
const HOLDERS_DATA = {
  ...
  snapshots: [
    ...
    },
    {
      ...
      // governments: Arkham Intelligence via River/KuCoin (май 2026) —
      // 305,000 BTC. ПРОТИВОРЕЧИЕ: MEXC даёт 432,000 BTC (2.1%) на ту
      // же примерно дату. Выбран Arkham как специализированный
      // ончейн-трекер именно по государственным кошелькам, MEXC —
      // общий агрегатор. Расхождение ~127,000 BTC не разрешено,
      // требует сверки при следующем обновлении.
      ...
      categories: {
        individuals:  { pct: 67.6, btc: 14198066 },
        lost_satoshi: { pct: 12.7, btc: 2670000  },
        governments:  { pct: 1.45, btc: 305000   },
