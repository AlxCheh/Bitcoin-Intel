...
const CLUSTER_PRESET_QUESTIONS = {
  ...
  btc_payment_adoption:        ['Используют ли BTC для переводов в Сальвадоре?', 'Стал ли Bitcoin платёжным средством на практике?', 'Что происходит с Chivo-кошельком?', 'Растут ли крипто-переводы в Сальвадоре?'],
...
const DIGEST_CLUSTER_LABELS = {
  ...
  btc_payment_adoption: '💸 ПЛАТЁЖНОЕ СРЕДСТВО',
  ...
  post_subsidy_security_budget: '🛡️ SECURITY BUDGET',
};
...
const CLUSTER_LABELS_AI = {
  ...
  btc_payment_adoption:        '💸 BTC как платёжное средство',
  ...
  post_subsidy_security_budget: '🛡️ Security budget: экономика после субсидии'
};
...
// вместо инлайн document.getElementById(id).scrollIntoView(...) (см.
